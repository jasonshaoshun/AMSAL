...
partial_supervision = true; model_name = 'BertModel'; experiments = 'normal_twitter_sentiment'; bias_name = 'age_gender'; \
...
k=4; biases_num = 2; biases_dim = [0, 3, 5]; include_complex_Z = false; complex_index = []; main_partialsup; exit"
