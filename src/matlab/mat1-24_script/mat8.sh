...
partial_supervision = true; model_name = 'BertModel'; experiments = 'normal_twitter_sentiment'; bias_name = 'age'; \
...
k=4; biases_num = 1; biases_dim = [0, 3]; include_complex_Z = false; complex_index = []; main_partialsup; exit"
