...
partial_supervision = true; partial_ratio = 0.7; run_kmeans = false; save_oracle = false;\
include_complex_Z = false; model_name = 'FastText'; experiments_folder = 'biography_different_partial_n'; experiments = 'biography'; bias_name = 'gender';\
