...
def _parse_experiment_id(experiment_id):
    ...
    for item in items:
        ...
        if id_ == "d":
            ...
            assignment_ratio = val
        else:
            raise ValueError(f"Unrecognized ID {id_}.")

    return debiasing, model, experiment, assignment, assignment_ratio
...
if __name__ == "__main__":
    ...
    for experiment in results:
        ...
        debiasing, model, experiment, assignment, assignment_ratio = _parse_experiment_id(experiment["experiment_id"])
    ...
    df = df[df["assignment_ratio"] == args.assignment_ratio]
