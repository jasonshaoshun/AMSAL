...
def find_best_hyperparameters_linearSVC(assignment_mat_path, dataset_npz_path, classify_main_or_protected = "main_label"):
    x_train, y_p_train, y_m_train, x_dev, y_p_dev, y_m_dev \
                = load_assigned_dataset(assignment_mat_path, dataset_npz_path)
...
def find_best_hyperparameters_logistic_regression(assignment_mat_path, dataset_npz_path, classify_main_or_protected = "main_label"):
    ...
    x_train, y_p_train, y_m_train, x_dev, y_p_dev, y_m_dev = load_assigned_dataset(assignment_mat_path, dataset_npz_path)
...
if __name__ == "__main__":
    ...
    best_acc, best_penalty, best_loss, best_C, best_multi_class, best_class_weight, hyperparameter_performance = find_best_hyperparameters_linearSVC(args.dataset_path, classify_main_or_protected = "protected_label")
    ...
    best_acc, best_penalty, best_loss, best_C, best_multi_class, best_class_weight, hyperparameter_performance = find_best_hyperparameters_linearSVC(args.dataset_path, classify_main_or_protected = "main_label")
