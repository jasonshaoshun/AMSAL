...
def compute_projection_matrix(model, tokenizer, bias_type, n_classifiers=80, path = ""):
    """Runs INLP.
    ...
    #         )
    # elif pre_assignment == "True":
    #     saved_dataset = np.load(path)
