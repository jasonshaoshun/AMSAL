...
class CrowSPairsRunner:
    ...
    def __call__(self):
        if self._is_generative:
            results, Stereotype_score, Anti_Stereotype_score  = self._likelihood_score_generative()
            return results, Stereotype_score, Anti_Stereotype_score
        else:
            results, Stereotype_score, Anti_Stereotype_score = self._likelihood_score()
            return results, Stereotype_score, Anti_Stereotype_score
    ...
    def _likelihood_score(self):
        ...
        Stereotype_score = round((stereo_score + antistereo_score) / N * 100, 2)
        Anti_Stereotype_score = round(antistereo_score / total_antistereo * 100, 2)

        return round((stereo_score + antistereo_score) / N * 100, 2), Stereotype_score, Anti_Stereotype_score
