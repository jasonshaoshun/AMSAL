...
#             experiment_id="glue_m-INLPBertForSequenceClassification_c-bert-base-uncased_t-gender_p-${pre_assignment_type}"
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/projection_matrix/projection_m-${debiased_model_to_base_model["INLPBertForSequenceClassification"]}_c-${model_to_model_name_or_path["INLPBertForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-INLPAlbertForSequenceClassification_c-albert-base-v2_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gres=gpu:1 \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/projection_matrix/projection_m-${debiased_model_to_base_model["INLPAlbertForSequenceClassification"]}_c-${model_to_model_name_or_path["INLPAlbertForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-INLPRobertaForSequenceClassification_c-roberta-base_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gpus 1 \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/projection_matrix/projection_m-${debiased_model_to_base_model["INLPRobertaForSequenceClassification"]}_c-${model_to_model_name_or_path["INLPRobertaForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-INLPGPT2ForSequenceClassification_c-gpt2_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gres=gpu:1 \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/projection_matrix/projection_m-${debiased_model_to_base_model["INLPGPT2ForSequenceClassification"]}_c-${model_to_model_name_or_path["INLPGPT2ForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-SALBertForSequenceClassification_c-bert-base-uncased_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gres=gpu:1 \
...
#                     -e ${persistent_dir}/logs/%x.%j.err \
#                     python_job.sh experiments/run_glue.py \
#                         --model "SALBertForSequenceClassification" \
#                         --model_name_or_path "bert-base-uncased" \
#                         --task_name ${task} \
#                         --do_train \
#                         --do_eval \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/eigenvectors/projection_m-${debiased_model_to_masked_lm_model["SALBertForSequenceClassification"]}_c-${model_to_model_name_or_path["SALBertForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-SALAlbertForSequenceClassification_c-albert-base-v2_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gres=gpu:1 \
...
#                     -e ${persistent_dir}/logs/%x.%j.err \
#                     python_job.sh experiments/run_glue.py \
#                         --model "SALAlbertForSequenceClassification" \
#                         --model_name_or_path "albert-base-v2" \
#                         --task_name ${task} \
#                         --do_train \
#                         --do_eval \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/eigenvectors/projection_m-${debiased_model_to_masked_lm_model["SALAlbertForSequenceClassification"]}_c-${model_to_model_name_or_path["SALAlbertForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-SALRobertaForSequenceClassification_c-roberta-base_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gres=gpu:1 \
...
#                     -e ${persistent_dir}/logs/%x.%j.err \
#                     python_job.sh experiments/run_glue.py \
#                         --model "SALRobertaForSequenceClassification" \
#                         --model_name_or_path "roberta-base" \
#                         --task_name ${task} \
#                         --do_train \
#                         --do_eval \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/eigenvectors/projection_m-${debiased_model_to_masked_lm_model["SALRobertaForSequenceClassification"]}_c-${model_to_model_name_or_path["SALRobertaForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         for pre_assignment_type in ${pre_assignment_types[@]}; do
#             experiment_id="glue_m-SALGPT2ForSequenceClassification_c-gpt2_t-gender_p-${pre_assignment_type}"
#             if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#                 echo "${experiment_id}_g-${task}_s-${seed}"
#                 sbatch \
#                     --gres=gpu:1 \
...
#                     -e ${persistent_dir}/logs/%x.%j.err \
#                     python_job.sh experiments/run_glue.py \
#                         --model "SALGPT2ForSequenceClassification" \
#                         --model_name_or_path "gpt2" \
#                         --task_name ${task} \
#                         --do_train \
#                         --do_eval \
...
#                         --num_train_epochs 3 \
#                         --seed ${seed} \
#                         --projection_matrix "${persistent_dir}/results/eigenvectors/projection_m-${debiased_model_to_masked_lm_model["SALGPT2ForSequenceClassification"]}_c-${model_to_model_name_or_path["SALGPT2ForSequenceClassification"]}_t-gender_s-0_p-${pre_assignment_type}.pt" \
#                         --output_dir "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}"
#             fi
#         done
#     done
...
#     for task in ${glue_tasks[@]}; do
#         experiment_id="glue_m-BertForSequenceClassification_c-bert-base-uncased_p-Oracle"
#         if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#             echo "${experiment_id}_g-${task}_s-${seed}"
#             sbatch \
#                 --gres=gpu:1 \
...
# for seed in 2; do
#     for task in ${glue_tasks[@]}; do
#         experiment_id="glue_m-AlbertForSequenceClassification_c-albert-base-v2_p-Oracle"
#         if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#             echo "${experiment_id}_g-${task}_s-${seed}"
#             sbatch \
#                 --gres=gpu:1 \
...
for seed in 0; do
    for task in ${glue_tasks[@]}; do
        experiment_id="glue_m-RobertaForSequenceClassification_c-bert-base-uncased_p-Oracle"
        if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
            echo "${experiment_id}_g-${task}_s-${seed}"
            sbatch \
                --gres=gpu:1 \
...
# for seed in 0 1 2; do
#     for task in ${glue_tasks[@]}; do
#         experiment_id="glue_m-GPT2ForSequenceClassification_c-gpt2_p-Oracle"
#         if [ ! -f "${persistent_dir}/checkpoints/${experiment_id}/${seed}/${task}/eval_results.json" ]; then
#             echo "${experiment_id}_g-${task}_s-${seed}"
#             sbatch \
#                 --gres=gpu:1 \
