...
import torch
import transformers
print(f"\n\n\n\ntorch.__version__ is {torch.__version__}\n\n")
print(f"\n\ntorch.version.cuda is {torch.version.cuda}\n\n\n\n")
...
if __name__ == "__main__":
    ...
    projection_matrix = compute_projection_matrix(
        ...
        path=f"{args.pre_assignment_path}",
    )
    ...
    #         f"{args.persistent_dir}/results/projection_matrix/{experiment_id}.pt",
    #     )
    # # choices=["Sal", "Kmeans", "Oracle"],
    # elif args.pre_assignment == "True":
    #     if args.pre_assignment_type == "Sal":

    #         print(
    #             f"Saving computed projection matrix to: {args.persistent_dir}/results/projection_matrix/preassignment_sal_{experiment_id}.pt"
    #         )
    ...
    #         torch.save(
    #             projection_matrix,
    #             f"{args.persistent_dir}/results/projection_matrix/preassignment_sal_{experiment_id}.pt",
    #         )
    #     elif args.pre_assignment_type == "Kmeans":
    #         print(
    #             f"Saving computed projection matrix to: {args.persistent_dir}/results/projection_matrix/preassignment_kmeans_{experiment_id}.pt"
    #         )
    ...
    #         torch.save(
    #             projection_matrix,
    #             f"{args.persistent_dir}/results/projection_matrix/preassignment_kmeans_{experiment_id}.pt",
    #         )
    #     elif args.pre_assignment_type == "Oracle":
    #         print(
    #             f"Saving computed projection matrix to: {args.persistent_dir}/results/projection_matrix/preassignment_oracle_{experiment_id}.pt"
    #         )
    ...
    #         torch.save(
    #             projection_matrix,
    #             f"{args.persistent_dir}/results/projection_matrix/preassignment_oracle_{experiment_id}.pt",
    #         )
    # else:
    #     print("Wrong argument --pre_assignment, should be either True or False")
